      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-zinc-500">
            Perfil, color en calendario y servicios asignados
          </p>
        </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-500">
                    Color calendario: {user.color}
                  </p>
                </div>
              </div>

              <div className="mt-3 text-sm text-zinc-600 dark:text-zinc-300">
                Servicios asignados y comisiones configurables en Supabase.
                Conecta esta tarjeta a la tabla <code>app_users</code> para
              ...
              <div className="mt-3 space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {safeAppointments
                    .filter(
                      (appt) => appt.especialista === user.name
                    )
                    .map((appt) => (
                      <span
                        key={appt.id}
